<?php 
 $id = $_GET['id'];
$sql2 = $conn->query("SELECT * FROM pengguna WHERE id ='$id'");
...
if (isset($_POST['simpan'])) {
    ...
    $sql = $conn->query("UPDATE pengguna SET username = '$username', nama ='$nama',level ='$level',foto ='$foto' WHERE id = '$id'");
    ...
    $sql = $conn->query("UPDATE pengguna SET username = '$username',nama ='$nama',level ='$level'WHERE id = '$id'");
